...
if (!function_exists('dark_theme_simplicity_customizer_css')) {
    function dark_theme_simplicity_customizer_css() {
        ...
        $hero_button_radius = get_theme_mod('dark_theme_simplicity_hero_button_radius', '0');
        $hero_button_padding_x = get_theme_mod('dark_theme_simplicity_hero_button_padding_x', '32');
        $hero_button_padding_y = get_theme_mod('dark_theme_simplicity_hero_button_padding_y', '16');
        $hero_button_text_size = get_theme_mod('dark_theme_simplicity_hero_button_text_size', '18');
        $hero_button_font_weight = get_theme_mod('dark_theme_simplicity_hero_button_font_weight', '500');
        $hero_button_border_width = get_theme_mod('dark_theme_simplicity_hero_button_border_width', '0');
        $hero_button_border_color = get_theme_mod('dark_theme_simplicity_hero_button_border_color', '#ffffff');
        ...
        <style type="text/css">
            ...
            :root {
                ...
                --hero-btn-radius: <?php echo esc_attr($hero_button_radius); ?>px;
                --hero-btn-padding-x: <?php echo esc_attr($hero_button_padding_x); ?>px;
                --hero-btn-padding-y: <?php echo esc_attr($hero_button_padding_y); ?>px;
                --hero-btn-text-size: <?php echo esc_attr($hero_button_text_size); ?>px;
                --hero-btn-font-weight: <?php echo esc_attr($hero_button_font_weight); ?>;
                --hero-btn-border-width: <?php echo esc_attr($hero_button_border_width); ?>px;
                --hero-btn-border-color: <?php echo esc_attr($hero_button_border_color); ?>;
            ...
            .hero-btn {
                ...
                padding-left: var(--hero-btn-padding-x) !important;
                padding-right: var(--hero-btn-padding-x) !important;
                padding-top: var(--hero-btn-padding-y) !important;
                padding-bottom: var(--hero-btn-padding-y) !important;
                font-size: var(--hero-btn-text-size) !important;
                font-weight: var(--hero-btn-font-weight) !important;
                border-width: var(--hero-btn-border-width) !important;
