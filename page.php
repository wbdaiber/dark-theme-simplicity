                ...
                <article <?php post_class('page-content bg-dark-300 p-6 rounded-lg border border-white/10'); ?>>
                    ...
                    <?php if ($show_toc === '1' && !is_front_page() && !is_home()): ?>
                        <div class="table-of-contents bg-dark-100 p-4 mb-6 rounded-lg border border-white/10">
                            <div class="toc-heading flex items-center justify-between mb-3">
                                <span class="toc-title text-lg font-bold text-white" role="heading" aria-level="2"><?php _e('Table of Contents', 'dark-theme-simplicity'); ?></span>
                            </div>
                    ...
                    <?php if ($show_share === '1'): ?>
                        <div class="share-buttons mt-8 pt-4 border-t border-white/10">
                            <div class="share-title text-lg font-bold text-white mb-3" role="heading" aria-level="2"><?php _e('Share This', 'dark-theme-simplicity'); ?></div>
