<!-- Services Section -->
<section id="what-we-do" class="py-20 px-4 md:px-0 services-section">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
            ...
            if (!empty($service_items)) {
                foreach ($service_items as $index => $service) {
                    ...
                    ?>
                    <div class="service-card p-8 rounded-lg border border-zinc-700/30 hover:border-blue-500 hover:border-2 hover:translate-y-[-5px] transition-all duration-300 shadow-md hover:shadow-blue-500/20 group animate-fade-in <?php echo esc_attr($delay_class); ?>" style="transition: all 0.3s ease; background-color: <?php echo esc_attr($service_bg_color); ?> !important;">
                ...
                ?>
                <div class="service-card p-8 rounded-lg border border-zinc-700/30 hover:border-blue-500 hover:border-2 hover:translate-y-[-5px] transition-all duration-300 shadow-md hover:shadow-blue-500/20 group animate-fade-in" style="transition: all 0.3s ease; background-color: <?php echo esc_attr($service_bg_color); ?> !important;">
                    <div class="p-4 rounded-lg w-18 h-18 mb-6 flex items-center justify-center transition-all">
                ...
                <div class="service-card p-8 rounded-lg border border-zinc-700/30 hover:border-blue-500 hover:border-2 hover:translate-y-[-5px] transition-all duration-300 shadow-md hover:shadow-blue-500/20 group animate-fade-in animation-delay-200" style="transition: all 0.3s ease; background-color: <?php echo esc_attr($service_bg_color); ?> !important;">
                    <div class="p-4 rounded-lg w-18 h-18 mb-6 flex items-center justify-center transition-all">
                        <svg class="w-10 h-10 text-blue-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
                ...
                <div class="service-card p-8 rounded-lg border border-zinc-700/30 hover:border-blue-500 hover:border-2 hover:translate-y-[-5px] transition-all duration-300 shadow-md hover:shadow-blue-500/20 group animate-fade-in animation-delay-400" style="transition: all 0.3s ease; background-color: <?php echo esc_attr($service_bg_color); ?> !important;">
                    <div class="p-4 rounded-lg w-18 h-18 mb-6 flex items-center justify-center transition-all">
                        <svg class="w-10 h-10 text-blue-300" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
