...
// This would map to front-page.php in WordPress
// Dynamic content would be pulled from WordPress fields, ACF, or other sources
const Homepage = () => {
  // In WordPress, these would be ACF fields or other editable content
  const services = [
    {
      title: "Strategic SEO",
  ...
  return (
    <Layout>
      ...
      {/* Services Section - In WordPress, this would be editable via ACF fields */}
      <section id="what-we-do" className="py-12 px-4 sm:px-6 lg:px-8 relative scroll-mt-16">
              ...
              >
                <div className="flex items-start space-x-4">
                  ...
                  <div>
                    ...
                    <p className="text-light-100/70">{item.content}</p>
                  </div>
                </div>
              </div>
            ))}
