    ...
    <div class="container mx-auto px-4 py-16">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-12 mb-12">
            ...
            <div class="space-y-6">
                ...
                <p class="text-light-100/70 text-lg max-w-md">Helping businesses establish a powerful online presence through strategic digital marketing solutions.</p>
            </div>
            ...
            <div>
                ...
                if (has_nav_menu('footer')) {
                    wp_nav_menu(array(
                        ...
                        'fallback_cb'    => false,
                        'depth'          => 1,
                        'walker'         => new Dark_Theme_Simplicity_Walker_Footer_Menu(),
                    ));
                } else {
                    ...
                    <ul class="space-y-3">
                        ...
                        <li><a href="<?php echo esc_url(home_url('/about')); ?>" class="text-light-100/70 hover:text-blue-400 transition-colors">About</a></li>
                    </ul>
                    <?php
                }
                ?>
            ...
            <div>
                ...
                if (has_nav_menu('social')) {
                    wp_nav_menu(array(
                        ...
                        'link_before'    => '',
                        'link_after'     => '',
                        'walker'         => new Dark_Theme_Simplicity_Walker_Social_Menu(),
                    ));
                } else {
                    // Fallback to default social items if no menu is set
                    ?>
                    <div class="flex flex-col space-y-3">
                        <a href="#" class="flex items-center gap-3 text-light-100/70 hover:text-blue-400 transition-colors">
        ...
        <div class="pt-8 flex flex-col md:flex-row justify-between items-center border-t border-white/10">
            <p class="text-light-100/50 text-sm mb-4 md:mb-0">
                © <?php echo date('Y'); ?> Brad Daiber. All rights reserved.
            </p>
            ...
            <div class="flex space-x-6">
                ...
                if (has_nav_menu('legal')) {
                    ...
                    // Fallback to default legal items if no menu is set
                    ?>
                    <a href="#" class="text-light-100/50 hover:text-light-100 text-sm">Privacy Policy</a>
                    <a href="#" class="text-light-100/50 hover:text-light-100 text-sm">Terms of Service</a>
                    <a href="#" class="text-light-100/50 hover:text-light-100 text-sm">Cookie Policy</a>
                    <?php
                }
                ?>
            </div>
